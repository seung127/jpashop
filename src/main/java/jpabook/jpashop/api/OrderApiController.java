...
public class OrderApiController {
    ...
    public List<OrderDto> ordersV2() {
        List<Order> orders = orderRepository.findAllByString(new OrderSearch()); //2개의 결과
    ...
    @Data
    static class OrderDto { //멤버가지고 오고 배송 정보 가지고 오고 orderitemsㄷ 가지고 오고 너무 많은 쿼리들들
    ...
    /**
     * v3
     * 페이징 불가(ex.몇개 가지고와 .setFirstResult(1)_setMaxResults(100)
     **/
